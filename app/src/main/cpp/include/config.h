...
#define FFMPEG_CONFIGURATION "--target-os=android --prefix=../ffmpeg-android/arm64-v8a --enable-cross-compile --arch=aarch64 --cc=/root/android/ndk/android-ndk-r15c/toolchains/aarch64-linux-android-4.9/prebuilt/linux-x86_64/bin/aarch64-linux-android-gcc --cross-prefix=/root/android/ndk/android-ndk-r15c/toolchains/aarch64-linux-android-4.9/prebuilt/linux-x86_64/bin/aarch64-linux-android- --sysroot=/root/android/ndk/android-ndk-r15c/platforms/android-21/arch-arm64 --disable-everything --enable-hwaccels --enable-static --disable-shared --disable-doc --enable-neon --enable-asm --enable-small --enable-ffmpeg --disable-ffplay --disable-ffprobe --disable-debug --enable-gpl --enable-avdevice --disable-indevs --disable-outdevs --extra-cflags='-Os -fPIC -I../ffmpeg-android/arm64-v8a/include -I/root/lame-3.100/android/arm64-v8a/include' --extra-ldflags='-lc -lm -ldl -llog -lgcc -lz -L../ffmpeg-android/arm64-v8a/lib -L/root/lame-3.100/android/arm64-v8a/lib' --enable-avcodec --enable-avformat --enable-avutil --enable-swresample --enable-swscale --enable-avfilter --disable-network --enable-libmp3lame --enable-encoder='aac,aac_mf,ac3,ac3_fixed,ac3_mf,adpcm_adx,adpcm_argo,g722,g726,g726le,adpcm_ima_alp,adpcm_ima_amv,adpcm_ima_apm,adpcm_ima_qt,adpcm_ima_ssi,adpcm_ima_wav,adpcm_ima_ws,adpcm_ms,adpcm_swf,adpcm_yamaha,alac,libopencore_amrnb,libvo_amrwbenc,aptx,aptx_hd,comfortnoise,dfpwm,dca,eac3,flac,g723_1,libgsm,libgsm_ms,libilbc,mlp,mp2,mp2fixed,libtwolame,libmp3lame,libshine,mp3_mf,nellymoser,opus,libopus,pcm_alaw,pcm_bluray,pcm_dvd,pcm_f32be,pcm_f32le,pcm_f64be,pcm_f64le,pcm_mulaw,pcm_s16be,pcm_s16be_planar,pcm_s16le,pcm_s16le_planar,pcm_s24be,pcm_s24daud,pcm_s24le,pcm_s24le_planar,pcm_s32be,pcm_s32le,pcm_s32le_planar,pcm_s64be,pcm_s64le,pcm_s8,pcm_s8_planar,pcm_u16be,pcm_u16le,pcm_u24be,pcm_u24le,pcm_u32be,pcm_u32le,pcm_u8,pcm_vidc,real_144,roq_dpcm,s302m,sbc,sonic,sonicls,libspeex,truehd,tta,vorbis,libvorbis,wavpack,wmav1,wmav2' --enable-decoder='8svx_exp,8svx_fib,aac,aac_fixed,aac_latm,ac3,ac3_fixed,adpcm_4xm,adpcm_adx,adpcm_afc,adpcm_aica,adpcm_ct,adpcm_dtk,adpcm_ea,adpcm_ea_maxis_xa,adpcm_ea_r1,adpcm_ea_r2,adpcm_ea_r3,adpcm_ea_xas,g722,g726,g726le,adpcm_ima_amv,adpcm_ima_apc,adpcm_ima_dat4,adpcm_ima_dk3,adpcm_ima_dk4,adpcm_ima_ea_eacs,adpcm_ima_ea_sead,adpcm_ima_iss,adpcm_ima_oki,adpcm_ima_qt,adpcm_ima_rad,adpcm_ima_smjpeg,adpcm_ima_wav,adpcm_ima_ws,adpcm_ms,adpcm_mtaf,adpcm_psx,adpcm_sbpro_2,adpcm_sbpro_3,adpcm_sbpro_4,adpcm_swf,adpcm_thp,adpcm_thp_le,adpcm_vima,adpcm_xa,adpcm_yamaha,alac,amrnb,amrwb,ape,atrac1,atrac3,atrac3al,atrac3plus,atrac3plusal,on2avc,binkaudio_dct,binkaudio_rdft,bmv_audio,comfortnoise,cook,dolby_e,dsd_lsbf,dsd_lsbf_planar,dsd_msbf,dsd_msbf_planar,dsicinaudio,dss_sp,dst,dca,dvaudio,eac3,evrc,flac,g723_1,g729,gremlin_dpcm,gsm,gsm_ms,iac,imc,interplay_dpcm,interplayacm,mace3,mace6,metasound,mlp,mp1,mp1float,mp2,mp2float,mp3,mp3float,mp3adu,mp3adufloat,mp3on4,mp3on4float,als,mpc7,mpc8,nellymoser,opus,libopus,paf_audio,pcm_alaw,pcm_bluray,pcm_dvd,pcm_f16le,pcm_f24le,pcm_f32be,pcm_f32le,pcm_f64be,pcm_f64le,pcm_lxf,pcm_mulaw,pcm_s16be,pcm_s16be_planar,pcm_s16le,pcm_s16le_planar,pcm_s24be,pcm_s24daud,pcm_s24le,pcm_s24le_planar,pcm_s32be,pcm_s32le,pcm_s32le_planar,pcm_s64be,pcm_s64le,pcm_s8,pcm_s8_planar,pcm_u16be,pcm_u16le,pcm_u24be,pcm_u24le,pcm_u32be,pcm_u32le,pcm_u8,pcm_zork,qcelp,qdm2,qdmc,real_144,real_288,ralf,roq_dpcm,s302m,sdx2_dpcm,shorten,sipr,smackaud,sol_dpcm,sonic,tak,truehd,truespeech,tta,twinvq,vmdaudio,vorbis,libvorbis,wavesynth,wavpack,ws_snd1,wmalossless,wmapro,wmav1,wmav2,wmavoice,xan_dpcm,xma1,xma2,h264,h264_qsv,h264_cuvid' --enable-muxer='3g2,3gp,a64,ac3,adts,adx,aiff,alaw,alp,amr,amv,apm,apng,aptx,aptx_hd,argo_cvg,ass,ast,au,avi,avif,avm2,avs2,avs3,bit,caca,caf,cavsvideo,chromaprint,codec2,codec2raw,crc,dash,data,daud,dfpwm,dirac,dnxhd,dts,dv,dvd,eac3,f32be,f32le,f4v,f64be,f64le,ffmetadata,fifo,fifo_test,film_cpk,filmstrip,fits,flac,flv,framecrc,framehash,framemd5,g722,g723_1,g726,g726le,gif,gsm,gxf,h261,h263,h264,hash,hds,hevc,hls,ico,ilbc,image2,image2pipe,ipod,ircam,ismv,ivf,jacosub,kvag,latm,lrc,m4v,matroska,md5,microdvd,mjpeg,mkvtimestamp_v2,mlp,mmf,mov,mp2,mp3,mp4,mpeg,mpeg1video,mpeg2video,mpegts,mpjpeg,mulaw,mxf,mxf_d10,mxf_opatom,null,nut,obu,oga,ogg,ogv,oma,opus,psp,rawvideo,rm,roq,rso,rtp,rtp_mpegts,rtsp,s16be,s16le,s24be,s24le,s32be,s32le,s8,sap,sbc,scc,sdl,sdl2,segment,smjpeg,smoothstreaming,sox,spdif,spx,srt,stream_segment,ssegment,streamhash,sup,svcd,swf,tee,truehd,tta,ttml,u16be,u16le,u24be,u24le,u32be,u32le,u8,uncodedframecrc,vc1,vc1test,vcd,vidc,vob,voc,w64,wav,webm,webm_chunk,webm_dash_manifest,webp,webvtt,wsaud,wtv,wv,yuv4mpegpipe' --enable-filter='abench,acompressor,acontrast,acopy,acue,acrossfade,acrossover,acrusher,adeclick,adeclip,adecorrelate,adelay,adenorm,aderivative,adrc,adynamicequalizer,adynamicsmooth,aecho,aemphasis,aeval,aexciter,afade,afftdn,afftfilt,afir,aformat,afreqshift,afwtdn,agate,aiir,aintegral,ainterleave,alatency,alimiter,allpass,aloop,amerge,ametadata,amix,amultiply,anequalizer,anlmdn,anlmf,anlms,anull,apad,aperms,aphaser,aphaseshift,apsyclip,apulsator,arealtime,aresample,areverse,arnndn,asdr,asegment,aselect,asendcmd,asetnsamples,asetpts,asetrate,asettb,ashowinfo,asidedata,asoftclip,aspectralstats,asplit,astats,astreamselect,asubboost,asubcut,asupercut,asuperpass,asuperstop,atempo,atilt,atrim,axcorrelate,azmq,bandpass,bandreject,bass,biquad,bs2b,channelmap,channelsplit,chorus,compand,compensationdelay,crossfeed,crystalizer,dcshift,deesser,dialoguenhance,drmeter,dynaudnorm,earwax,ebur128,equalizer,extrastereo,firequalizer,flanger,haas,hdcd,headphone,highpass,highshelf,join,ladspa,loudnorm,lowpass,lowshelf,mcompand,pan,replaygain,rubberband,sidechaincompress,sidechaingate,silencedetect,silenceremove,sofalizer,speechnorm,stereotools,stereowiden,superequalizer,surround,tiltshelf,treble,tremolo,vibrato,virtualbass,volume,volumedetect,aevalsrc,afirsrc,anoisesrc,anullsrc,flite,hilbert,sinc,sine,anullsink' --enable-parsers --enable-protocols --enable-postproc --enable-jni --disable-demuxers --cpu=armv8-a"
